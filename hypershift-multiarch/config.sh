...
export ASSISTED_INSTALLER_IMAGE="registry.redhat.io/rhai-tech-preview/assisted-installer-rhel8:latest"
export ASSISTED_CONTROLLER_IMAGE="registry.redhat.io/rhai-tech-preview/assisted-installer-reporter-rhel8:latest"
export ASSISTED_AGENT_IMAGE="registry.redhat.io/rhai-tech-preview/assisted-installer-agent-rhel8:latest"
